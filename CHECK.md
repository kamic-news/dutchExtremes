...
1. Goto https://github.com/orgs/kamic-news/people  
...
1. Please register with username (i.e.: kamic_news) at https://www.geonames.org/login  
2. Assign the choosen username as new organization secret at https://github.com/organizations/kamic-news/settings/secrets/actions/new  
   * Name:  **GEONAMES_KEY**   
...
3. Assign the API key as (new?) organization secret or edit it at https://github.com/organizations/kamic-news/settings/secrets/actions  
   * Name:  **RAPIDAPI_KEY**   
   * Value: **Your key here**   
